...
function updateProgress() {
    ...
    // Check if all flowers are revealed
    if (revealedRoses.size === flowerData.length) {
...
// ====== SHOW LETTER ======
function showLetter() {
    document.getElementById('letter-backdrop').classList.add('show');
...
function closeLetter() {
    document.getElementById('letter-backdrop').classList.remove('show');
